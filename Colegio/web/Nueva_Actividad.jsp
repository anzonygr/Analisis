<%-- 
    Document   : Nueva_Actividad
    Created on : 15-may-2019, 0:37:56
    Author     : ASUS
--%>
...
<html>
    ...
    <body>
        ...
        <form action="Crear_Tarea.jsp" method="post">
            ...
            <div class="content-wrapper col-12">
                <div class="container-fluid ">
                    ...
                    <table class="col table table-striped table-bordered table-responsive">
                        ...
                        <button type="submit" name="prueba" value="<%=codigo%>" class="btn btn-primary">Nueva Tarea</button>
