...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-05-2019 a las 21:26:40
...
ALTER TABLE `catedratico`
  ...
  ADD UNIQUE KEY `NOMBRE_APELLIDO_CATEDRATICO` (`NOMBRE`,`APELLIDO`),
...
ALTER TABLE `encargado`
  ...
  ADD UNIQUE KEY `NOMBRE_APELLIDO_ENCARGADO` (`NOMBRE`,`APELLIDO`),
  ADD KEY `COD_ROL` (`COD_ROL`);
...
ALTER TABLE `estudiante`
  ...
  ADD UNIQUE KEY `NOMBRE_APELLIDO_ESTUDIANTE` (`NOMBRE`,`APELLIDO`),
  ADD KEY `COD_ROL` (`COD_ROL`),
...
--
ALTER TABLE `login`
  ADD PRIMARY KEY (`COD_LOGIN`,`COD_ROL`),
  ADD KEY `COD_ROL` (`COD_ROL`);
...
--
ALTER TABLE `actividad`
  MODIFY `COD_ACTIVIDAD` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `asignacion`
--
ALTER TABLE `asignacion`
  MODIFY `COD_ASIGNACION` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `catedratico`
--
ALTER TABLE `catedratico`
  MODIFY `COD_CATEDRATICO` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `encargado`
  MODIFY `COD_ENCARGADO` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `entrega_actividad`
--
ALTER TABLE `entrega_actividad`
  MODIFY `COD_ENTREGA_ACTIVIDAD` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `grado`
  MODIFY `COD_GRADO` int(11) NOT NULL AUTO_INCREMENT;
